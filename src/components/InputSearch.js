...
const InputSearch = ({placeholder, width = '80%',name , deleteTagSearch, tagSearch = [], value, onChange, modal, onSelect, data, prop, tags = [], onSelectTag, customItemModal = undefined, onKeyUp = ()=>{}}) => {
